...
+ une partie théorique définissant quelques notions essentielles, d'aborder des questions de méthodologie. Cette partie permet egalement de faire un retor d'expérience.
...
Ce cours doit vous permettre de monter en compétences sur ces domaines:
+ Modélisation 2D-3D
+ Fabrication additives, soustractives
